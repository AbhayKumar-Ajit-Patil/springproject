    ...
    <div class="card-container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><strong>Website:</strong> <%= contact.getWebsite() %></p>
                <div class="action-buttons">
                    <a href="./edit-contact?id=<%= contact.getId() %>" class="edit-button">Edit</a>
                    <a href="./delete-contact?id=<%= contact.getId() %>" class="delete-button">Delete</a>
                </div>
            </div>
        </div>
        <% } %>
